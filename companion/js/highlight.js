(function () {
    ...
    function highlight(){
		...
		//"model", "type", "variant", "size", "classes", 
		...
		//var valueA = (document.getElementById( Stat_ID_A ).innerHTML);
		//var valueB = (document.getElementById( Stat_ID_B ).innerHTML);
		var comparestatus = [];
			 //console.log(valueA, comparestatus, valueB);
			...
			if (valueA == valueB) {
			 ...
			 //console.log("Higher", Stat_ID, valueA, comparestatus, valueB);
...
for (let x of shipstatsarray1) {
		...
		var comparestatus = [];
			...
			if (valueA == valueB) {
			 ...
			 //console.log("Lower", Stat_ID, valueA, comparestatus, valueB);
