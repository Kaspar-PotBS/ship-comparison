...
//Build table and add output
		...
		table.className = "nowrap hover dataTable";
...
//Build table and add output
        ...
        // CREATE DYNAMIC TABLE.
        var table = document.getElementById("ShipDataTable");
		table.className = "filter-table-style";
		table.className = "nowrap hover";
		table.setAttribute("id", "ShipDataTableInsert");
		var tbody = document.getElementById("ShipDatatbody");
        ...
        // ADD THE NEWLY CREATED TABLE WITH JSON DATA TO A CONTAINER.
        var divContainer = document.getElementById("ShipDataTable");
        divContainer.innerHTML = "";
        divContainer.appendChild(table);
